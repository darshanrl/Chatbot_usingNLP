...
file_path = os.path.abspath("C:\\Users\\omgow\\OneDrive\\Desktop\\P4-Implementation-of-Chatbot-using-NLP-main\\P4-Implementation-of-Chatbot-using-NLP-main\\intents.json")
